                ...
                <div class="col-xl-12">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form method="POST" action="{{ route('update_post', ['id' => $post->id ]) }}" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <input id="inputText3" type="text"  name="title" value="{{ $post->title }}" class="form-control" placeholder="post title">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="summernote" name="content" rows="6" placeholder="{{ $post->content}}">{{ $post->content}}</textarea>
                                        </div>
